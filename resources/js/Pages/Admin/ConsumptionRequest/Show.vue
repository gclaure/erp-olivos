            ...
            <div class="w-full lg:w-[68%] xl:w-[72%] space-y-4">
                ...
                >
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="text-xs font-black text-amber-800 dark:text-amber-400 uppercase tracking-wide">Insumos Faltantes Detectados en Almacén</h4>
                            <p class="text-[11px] text-amber-700/90 dark:text-amber-500/90 mt-0.5 uppercase font-bold tracking-tight leading-relaxed">
                                No hay stock físico suficiente para cubrir {{ totalMissingQuantity.toFixed(2) }} unidades solicitadas. Puede solicitar la compra de reposición de inmediato.
                            </p>
                        </div>
                    </div>
                    <button
                        ...
                        class="inline-flex items-center gap-1.5 px-3.5 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-xs font-black uppercase tracking-wider transition-colors shadow-sm whitespace-nowrap self-end sm:self-center"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
