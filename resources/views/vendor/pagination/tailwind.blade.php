                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="inline-flex items-center px-4 py-2 -ml-px text-sm font-bold text-white bg-indigo-600 border border-indigo-600 cursor-default leading-5 dark:bg-indigo-500 dark:border-indigo-500">{{ $page }}</span>
                                    </span>
                                @else
