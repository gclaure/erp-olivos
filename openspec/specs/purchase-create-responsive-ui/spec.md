# Especificación: Interfaz Responsiva para Registro de Compras

Especificación de requerimientos para la adaptabilidad responsiva móvil, tablet y escritorio del formulario de compras.
