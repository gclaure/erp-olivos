# Realtime Approval Websocket

Especificación de los eventos WebSocket que notifican las transiciones de estado de las solicitudes de consumo en tiempo real, y del comportamiento de `Show.vue` al recibirlos (toasts diferenciados y actualización de UI sin recarga).
