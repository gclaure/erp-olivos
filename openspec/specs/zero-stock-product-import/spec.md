# zero-stock-product-import

Especificación para la importación masiva de productos con stock cero en catálogo sin generar compras ni movimientos en el Kardex.
