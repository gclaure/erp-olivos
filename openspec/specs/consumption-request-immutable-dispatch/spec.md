# Especificación: Despacho Inmutable de Solicitudes de Consumo

Especificación de requerimientos para el bloqueo de cantidades y la simplificación visual de la columna de despacho en solicitudes de consumo interno.
