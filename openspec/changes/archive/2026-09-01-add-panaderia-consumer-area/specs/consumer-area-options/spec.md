...
### Requirement: Área Panadería disponible para Consumidores
El sistema SHALL permitir la selección y asignación del área "Panadería" a los usuarios que tengan el rol "Consumidor". Las áreas válidas del sistema MUST incluir: `Cocina`, `Pastelería`, `Panadería` y `Eventos`.
