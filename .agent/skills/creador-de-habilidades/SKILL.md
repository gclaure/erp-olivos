...
description: Utilidad para que Antigravity pueda generar, estructurar y documentar nuevas habilidades (.agent/skills) en el workspace siguiendo las mejores prácticas y en idioma español.
---
...
- Crear una carpeta única en `.agent/skills/<nombre-kebab-case>/`.
