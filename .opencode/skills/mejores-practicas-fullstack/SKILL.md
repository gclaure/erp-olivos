...
---
*Nota: Siempre referencia `.opencode/skills/inertia-vue-performance-optimizer/SKILL.md` para auditorías de rendimiento y `tailwind-rules.md` para convenciones de diseño.*